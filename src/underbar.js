(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var wrapped = function(val){
      return !test(val);
    };
    return _.filter(collection, wrapped);
  };
  ...
  _.reduce = function(collection, iterator, accumulator) {
    _.each(collection, function(item, ind, arr) {
  ...
  _.some = function(collection, iterator) {
    ...
    //reject and filter similar, double negative
    //_.every(collection, );
  };
